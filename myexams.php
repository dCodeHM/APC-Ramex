...
<div class="column">
    ...
    <div class="righthead">
        ...
        <div class="userhead">
            <p style="font-size: 50px; padding-bottom: 50px">My Exams</p>
        </div>
       ...
       <div class="popup-hidden">
                ...
                <div class="Add_popup">
                    <form action="coursefolder.php" method="post">
                        ...
                        <input type="hidden" name="course_subject" value="<?php echo $course_subject ?>" readonly><br />

                        <div class="inputcolumn">
                            <label class="label" for="program_name">Program Name</label><br />
                            <select class="input" list="program_name" name="program_name" required>
                        ...
                        <div class="inputcolumn">
                            ...
                            <input class="input" type="text" name="course_code" placeholder="Your Course Code" value="<?php echo $course_code ?>" required><br />
                        </div>
