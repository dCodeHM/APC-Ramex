                    ...
                    <form class="bg-zinc-100 outline outline-1 outline-zinc-200 rounded-xl" id="form" action="usersettingscode.php" method="POST">
                        <div class="flex-col flex p-10 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="first_name" value="<?php echo $row['first_name']; ?>" class="py-4 px-8 outline outline-1 w-[60%] outline-zinc-800 rounded-xl">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="last_name" value="<?php echo $row['last_name']; ?>" class="py-4 px-8 outline outline-1 outline-zinc-800 rounded-xl w-[60%]">
                            </div>
